...
Computation is done in a \textsc{slurm} cluster system of Technicsche Universität Dresden, Taurus.
...
\citet{piccoloToolsTechniquesComputational2016} mentions Jupyter notebooks as a notable example of literate programming tools.

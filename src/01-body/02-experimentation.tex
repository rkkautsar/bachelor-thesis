...
These requirements for an ideal benchmarking tool are compiled by identifying strengths and weaknesses of existing solutions (see Chapter \ref{ch:existing}).

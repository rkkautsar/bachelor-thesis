...
It is actively developed with the last release in 11th of February 2019 and licensed under the Apache License 2.0.
...
Accordingly, \cite{beyerReliableBenchmarkingRequirements2019} assess this measurement tool as not accurate nor reliable.

\citet{kordonBenchKitToolMassive2014} reported a boot-up overhead of 40 seconds per run in their experiment.
...
\textsc{JuBE} \citep{frings2010flexible} is a benchmarking environment developed by Jülich Supercomputing Centre (JSC) of Forschungszentrum Jülich.
It is actively developed, although with no public version control repository, with the last release in 4th of February 2019.

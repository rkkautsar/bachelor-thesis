...
\newcontent{This query mechanism described by \citeauthor{juvePracticalResourceMonitoring2015} can also be reworded as sampling as it can be seen as a more specialized form of statistical sampling.}
...
\newcontent{
    \textsc{runlim} \citep{RunLim} uses recursive sampling to monitor the resource usage.
